...
Process_Yield_UT = vectorY;
p <- plot_ly( x = PQI_Componente, 
              y = Process_Yield_UT,
              name="Process yield UT - PQI*",
              mode = "markers",
              type = "scatter",
              filename="Process yield UT")
layout(p, title = "Process yield UT - PQI*")
print(p)
...
# )
# 
# response <- py$plotly(data, kwargs=list(layout=layout, filename="ProcessYieldUT", fileopt="overwrite"))
# url <- response$url
# 
