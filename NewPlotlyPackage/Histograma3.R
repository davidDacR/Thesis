...
p <- plot_ly( x = WBS, 
              y = Cant_Defects_Size,
              name="Component total defect density",
              type = "bar",
              filename="histogramas/histograma3")
layout(p, title = "Component total defect density")
print(p)
...
# 
# layout <- list(
#   title = "Component total defect density",
...
# )
# 
# response <- py$plotly(data, kwargs=list(layout=layout, filename="Histograma3", fileopt="overwrite"))
# url <- response$url
